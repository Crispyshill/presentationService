...
ShoppingCartService cartService;
    ...
    @Autowired
    public ProductService(@Qualifier("productDataSource") DataSource secondDataSource) {
    ...
    public Product getProduct(String productId) {
        try (Connection connection = secondDataSource.getConnection();
            ...
            if (resultSet.next()) {
                ...
                throw new Exception(); // Replace NotFoundException with an appropriate exception class
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
